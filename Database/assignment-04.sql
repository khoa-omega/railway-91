...
-- Question 1: Viết lệnh để lấy ra danh sách
-- nhân viên và thông tin phòng ban của họ
SELECT *
FROM account
INNER JOIN department USING (department_id);

-- Question 2: Viết lệnh để lấy ra thông tin
-- các account được tạo sau ngày 20/12/2010
SELECT *
FROM account
INNER JOIN department USING (department_id)
...
-- Question 4: Viết lệnh để lấy ra danh sách
-- các phòng ban có > 2 nhân viên
