...
-- Question 11: Lấy ra nhân viên có tên
-- bắt đầu bằng chữ "D" và kết thúc bằng chữ "o"
SELECT *
FROM account
WHERE full_name LIKE "D%o";

-- Question 12: Xóa tất cả các exam
-- được tạo trước ngày 20/12/2019
DELETE FROM exam
WHERE create_date < "2019-12-20";

-- Question 13: Xóa tất cả các question
-- có nội dung bắt đầu bằng từ "câu hỏi"
DELETE FROM question
WHERE content LIKE "câu hỏi%";

-- Question 14: Update thông tin của account
-- có id = 5 thành tên "Nguyễn Bá Lộc" và
...
-- Question 15: Update account có id = 5
-- sẽ thuộc group có id = 4
